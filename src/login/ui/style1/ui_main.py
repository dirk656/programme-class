...
from src.login.core.camera_worker import CameraThread
from src.login.core.data_manager import DataManager
    ...
    def handle_recognize(self, name):
        ...
        try:
            ...
            if not DataManager.check_duplicate_sign(student_username):
                ...
                from src.login.core.service import CheckInService
